...
namespace PrismPM.Foundation.Integer
...
@[expose] public def checkedDivideInt64 (left : Int64) (right : Int64) : Option (Int64) := (LexLeanRuntime.checkedQuotientInt64 (left) (right) : Option (Int64))

end PrismPM.Foundation.Integer
